...
<html>
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        //console.log(data)
                        $('#texto-info-1').val(data.nombre_usu);
                        $('#texto-info-2').val(data.alias);
                        $('#texto-info-3').val(data.estado_usu);
                        $('#texto-info-4').val(data.celular);
                        $('#texto-info-5').val(data.email);
                        // $('div .perfil-info-1').val(data.nombre_usu);
                    }
                });
                $.ajax({
                    type: "get",
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            // console.log(data[i].nombre_usu);
                            var new_div = '<a id="' + i + '" onclick= "initChat(this,\'' + data[i].id_usu + '\')" href="javascript:void(0)"><img src="" class="foto"/><div class="persona">' + data[i].nombre_usu + '</div></a>';
                            $("#cc2").append(new_div);
                            // $("#cc3").append(new_div);
                        }
                    }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                             var new_div = '<a id="' + data[i].id_chat + '" onclick= "getchat(this,\'' + data[i].id_chat + '\')" href="javascript:void(0)"><img src="" class="foto"/><div class="persona" >' + data[i].nombre_chat + '</div></a>';
            ...
            function initChat(elemnt, clr) {

                console.log(clr);

            }
            
            function getchat(elemnt, clr) {
