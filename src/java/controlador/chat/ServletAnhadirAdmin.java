 ...
 * @author User
 */
// @WebServlet(name = "ServletAnhadirAdmin", urlPatterns = {"/ServletAnhadirAdmin"})
@WebServlet("/insertarAdminChat")
public class ServletAnhadirAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            contac_chat.insert_usuario_chat(id_chat, id_contc, true);
